        ...
        namespace DimmerConfigNS {
            ...
            public:
                typedef struct __attribute__packed__ DimmerConfig_t {
                    ...
                    #endif
                    CREATE_FLOAT_FIELD(on_fadetime, 1.0, 30.0, 7.5);
                    CREATE_FLOAT_FIELD(off_fadetime, 1.0, 30.0, 7.5);
                    CREATE_FLOAT_FIELD(lp_fadetime, 1.0, 30.0, 3.5);
                        ...
                        CREATE_UINT32_BITFIELD_MIN_MAX(min_brightness, 7, 0, 95, 15);
                        CREATE_UINT32_BITFIELD_MIN_MAX(max_brightness, 7, 5, 100, 100);
                    #endif
