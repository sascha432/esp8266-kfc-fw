...
FLASH_STRING_GENERATOR_AUTO_INIT(
    ...
    // src/WebUIComponent.cpp:14 (DEFINE), src/WebUIComponent.cpp:73 (SPGM), src/WebUIComponent.cpp:76 (SPGM), src/WebUIComponent.cpp:79 (SPGM)
    AUTO_STRING_DEF(webui_json_align, "align")
    // src/WebUIComponent.cpp:15 (DEFINE), src/WebUIComponent.cpp:156 (SPGM)
    AUTO_STRING_DEF(webui_json_badge, "badge")
    //
    AUTO_STRING_DEF(webui_json_big, "big")
    // src/WebUIComponent.cpp:16 (DEFINE), src/WebUIComponent.cpp:178 (SPGM)
    AUTO_STRING_DEF(webui_json_binary_sensor, "binary_sensor")
    // src/WebUIComponent.cpp:17 (DEFINE), src/WebUIComponent.cpp:195 (SPGM)
    AUTO_STRING_DEF(webui_json_button_group, "button_group")
    //
    AUTO_STRING_DEF(webui_json_buttons, "buttons")
    // src/WebUIComponent.cpp:18 (DEFINE), src/WebUIComponent.cpp:73 (SPGM)
    AUTO_STRING_DEF(webui_json_center, "center")
    // src/WebUIComponent.cpp:19 (DEFINE), src/WebUIComponent.cpp:138 (SPGM)
    AUTO_STRING_DEF(webui_json_color, "color")
    // include/WebUIComponent.h:96 (SPGM), src/WebUIComponent.cpp:20 (DEFINE), src/WebUIComponent.cpp:93 (SPGM), src/WebUIComponent.cpp:95 (SPGM), src/WebUIComponent.cpp:164 (SPGM)
    AUTO_STRING_DEF(webui_json_columns, "columns")
    // src/WebUIComponent.cpp:22 (DEFINE), src/WebUIComponent.cpp:218 (SPGM)
    AUTO_STRING_DEF(webui_json_data, "data")
    // src/WebUISocket.cpp:152 (SPGM)
    AUTO_STRING_DEF(webui_json_events, "events")
    //
    AUTO_STRING_DEF(webui_json_extra_classes, "extra_classes")
    // src/WebUIComponent.cpp:23 (DEFINE), src/WebUIComponent.cpp:103 (SPGM)
    AUTO_STRING_DEF(webui_json_group, "group")
    // src/WebUIComponent.cpp:24 (DEFINE), src/WebUIComponent.cpp:105 (SPGM)
    AUTO_STRING_DEF(webui_json_has_switch, "has_switch")
    //
    AUTO_STRING_DEF(webui_json_hb, "hb")
    //
    AUTO_STRING_DEF(webui_json_head, "head")
    // src/WebUIComponent.cpp:25 (DEFINE), src/WebUIComponent.cpp:188 (SPGM)
    AUTO_STRING_DEF(webui_json_height, "height")
    // include/WebUIComponent.h:83 (SPGM), src/WebUIComponent.cpp:26 (DEFINE)
    AUTO_STRING_DEF(webui_json_id, "id")
    // src/WebUIComponent.cpp:27 (DEFINE), src/WebUIComponent.cpp:198 (SPGM), src/WebUIComponent.cpp:208 (SPGM)
    AUTO_STRING_DEF(webui_json_items, "items")
    // src/WebUIComponent.cpp:28 (DEFINE), src/WebUIComponent.cpp:79 (SPGM)
    AUTO_STRING_DEF(webui_json_left, "left")
    // src/WebUIComponent.cpp:29 (DEFINE), src/WebUIComponent.cpp:205 (SPGM)
    AUTO_STRING_DEF(webui_json_listbox, "listbox")
    // src/WebUIComponent.cpp:30 (DEFINE), src/WebUIComponent.cpp:127 (SPGM)
    AUTO_STRING_DEF(webui_json_max, "max")
    // src/WebUIComponent.cpp:32 (DEFINE), src/WebUIComponent.cpp:126 (SPGM)
    AUTO_STRING_DEF(webui_json_min, "min")
    // src/WebUIComponent.cpp:54 (DEFINE), src/WebUIComponent.cpp:116 (SPGM)
    AUTO_STRING_DEF(webui_json_name, "name")
    // include/WebUIComponent.h:101 (SPGM), src/WebUIComponent.cpp:33 (DEFINE)
    AUTO_STRING_DEF(webui_json_offset, "offset")
    // src/WebUIComponent.cpp:34 (DEFINE), src/WebUIComponent.cpp:156 (SPGM), src/WebUIComponent.cpp:164 (SPGM)
    AUTO_STRING_DEF(webui_json_render_type, "render_type")
    // src/WebUIComponent.cpp:36 (DEFINE), src/WebUIComponent.cpp:144 (SPGM)
    AUTO_STRING_DEF(webui_json_rgb, "rgb")
    // src/WebUIComponent.cpp:35 (DEFINE), src/WebUIComponent.cpp:76 (SPGM)
    AUTO_STRING_DEF(webui_json_right, "right")
    // src/WebUIComponent.cpp:37 (DEFINE), src/WebUIComponent.cpp:61 (SPGM), src/WebUIComponent.cpp:160 (SPGM)
    AUTO_STRING_DEF(webui_json_row, "row")
    // src/WebUIComponent.cpp:38 (DEFINE), src/WebUIComponent.cpp:185 (SPGM)
    AUTO_STRING_DEF(webui_json_screen, "screen")
    // src/WebUIComponent.cpp:39 (DEFINE), src/WebUIComponent.cpp:150 (SPGM)
    AUTO_STRING_DEF(webui_json_sensor, "sensor")
    // src/WebUIComponent.cpp:40 (DEFINE), src/WebUIComponent.cpp:123 (SPGM), src/WebUIComponent.cpp:135 (SPGM)
    AUTO_STRING_DEF(webui_json_slider, "slider")
    // include/WebUIComponent.h:109 (SPGM), src/WebUIComponent.cpp:41 (DEFINE)
    AUTO_STRING_DEF(webui_json_state, "state")
    // src/WebUIComponent.cpp:42 (DEFINE), src/WebUIComponent.cpp:112 (SPGM)
    AUTO_STRING_DEF(webui_json_switch, "switch")
    // src/WebUIComponent.cpp:43 (DEFINE), src/WebUIComponent.cpp:138 (SPGM)
    AUTO_STRING_DEF(webui_json_temp, "temp")
    //
    AUTO_STRING_DEF(webui_json_temperature, "temperature")
    // include/WebUIComponent.h:87 (SPGM), src/WebUIComponent.cpp:44 (DEFINE), src/WebUIComponent.cpp:66 (SPGM)
    AUTO_STRING_DEF(webui_json_title, "title")
    // src/WebUIComponent.cpp:46 (DEFINE), src/WebUIComponent.cpp:61 (SPGM), src/WebUIComponent.cpp:103 (SPGM), src/WebUIComponent.cpp:112 (SPGM), src/WebUIComponent.cpp:123 (SPGM), src/WebUIComponent.cpp:135 (SPGM), src/WebUIComponent.cpp:150 (SPGM), src/WebUIComponent.cpp:178 (SPGM), src/WebUIComponent.cpp:185 (SPGM), src/WebUIComponent.cpp:195 (SPGM), src/WebUIComponent.cpp:217 (SPGM), src/WebUISocket.cpp:151 (SPGM)
    AUTO_STRING_DEF(webui_json_type, "type")
    // src/WebUISocket.cpp:151 (SPGM)
    AUTO_STRING_DEF(webui_json_ue, "ue")
    // src/WebUIComponent.cpp:49 (DEFINE), src/WebUIComponent.cpp:217 (SPGM)
    AUTO_STRING_DEF(webui_json_ui, "ui")
    // include/WebUIComponent.h:91 (SPGM), src/WebUIComponent.cpp:47 (DEFINE)
    AUTO_STRING_DEF(webui_json_unit, "unit")
    // include/WebUIComponent.h:105 (SPGM), src/WebUIComponent.cpp:50 (DEFINE)
    AUTO_STRING_DEF(webui_json_value, "value")
    //
    AUTO_STRING_DEF(webui_json_wide, "wide")
    // src/WebUIComponent.cpp:52 (DEFINE), src/WebUIComponent.cpp:187 (SPGM)
    AUTO_STRING_DEF(webui_json_width, "width")
    // src/WebUIComponent.cpp:53 (DEFINE), src/WebUIComponent.cpp:115 (SPGM), src/WebUIComponent.cpp:128 (SPGM)
    AUTO_STRING_DEF(webui_json_zero_off, "zero_off")
