...
class Adafruit_SPITFT : public GDI_GFX {

  public:

    Adafruit_SPITFT(uint16_t w, uint16_t h, int8_t cs, int8_t dc, int8_t mosi, int8_t sck, int8_t rst = -1, int8_t miso = -1) : GDI_GFX(w, h) {}
    Adafruit_SPITFT(uint16_t w, uint16_t h, int8_t cs, int8_t dc, int8_t rst = -1)  : GDI_GFX(w, h) {}
    Adafruit_SPITFT(uint16_t w, uint16_t h, SPIClass *spiClass, int8_t cs, int8_t dc, int8_t rst = -1) : GDI_GFX(w, h) {}
    Adafruit_SPITFT(uint16_t w, uint16_t h, tftBusWidth busWidth, int8_t d0, int8_t wr, int8_t dc, int8_t cs = -1, int8_t rst = -1, int8_t rd = -1) : GDI_GFX(w, h) {}
    ...
    uint8_t _command;
    int _writeWindowX, _writeWindowY;
