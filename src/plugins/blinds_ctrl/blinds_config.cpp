...
namespace KFCConfigurationClasses {
    ...
    Plugins::Blinds::BlindsConfig_t::BlindsConfig_t() :
        channels(), pins{IOT_BLINDS_CTRL_M1_PIN, IOT_BLINDS_CTRL_M2_PIN, IOT_BLINDS_CTRL_M3_PIN, IOT_BLINDS_CTRL_M4_PIN, IOT_BLINDS_CTRL_RSSEL_PIN},
        multiplexer(1), adc_divider(kAdcDividerDefault), pwm_frequency(kPwmFrequencyDefault), adc_read_interval(kAdcReadIntervalDefault), adc_recovery_time(kAdcRecoveryTimeDefault), adc_recoveries_per_second(kAdcRecoveriesPerSecDefault)
    {
    }


    Plugins::Blinds::BlindsConfigChannel_t::BlindsConfigChannel_t() : pwm_value(255), current_limit(200), current_limit_time(50), open_time(5000), close_time(5500) {
    }
