        ...
        namespace DoorOpenerConfigNS {
            ...
            #pragma GCC diagnostic ignored "-Woverflow"
                ...
                Blinds::BlindsConfig_t::BlindsConfig_t() :
                    channels(),
                    pins{IOT_BLINDS_CTRL_M1_PIN, IOT_BLINDS_CTRL_M2_PIN, IOT_BLINDS_CTRL_M3_PIN, IOT_BLINDS_CTRL_M4_PIN, IOT_BLINDS_CTRL_MULTIPLEXER_PIN, IOT_BLINDS_CTRL_DAC_PIN},
