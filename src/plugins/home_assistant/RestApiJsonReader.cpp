...
RestApiJsonReader::RestApiJsonReader() : JsonBaseReader(nullptr) {
}
...
bool RestApiJsonReader::processElement() {
...
bool RestApiJsonReader::recoverableError(JsonErrorEnum_t errorType) {
    return true;
}
