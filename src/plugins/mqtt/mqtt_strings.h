...
PROGMEM_STRING_DECL(mqtt_device_automation);
...
PROGMEM_STRING_DECL(mqtt_payload_high_speed);
PROGMEM_STRING_DECL(mqtt_payload_home);
PROGMEM_STRING_DECL(mqtt_payload_lock);
PROGMEM_STRING_DECL(mqtt_payload_locate);
PROGMEM_STRING_DECL(mqtt_payload_low_speed);
PROGMEM_STRING_DECL(mqtt_payload_medium_speed);
...
PROGMEM_STRING_DECL(mqtt_payload_off_speed);
...
PROGMEM_STRING_DECL(mqtt_speed_command_topic);
PROGMEM_STRING_DECL(mqtt_speed_state_topic);
PROGMEM_STRING_DECL(mqtt_speed_value_template);
PROGMEM_STRING_DECL(mqtt_speeds);
