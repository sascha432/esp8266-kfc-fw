...
PROGMEM_STRING_DECL(mqtt_available_tones);
...
PROGMEM_STRING_DECL(mqtt_brightness_command_template);
...
PROGMEM_STRING_DECL(mqtt_color_temp_kelvin);
...
PROGMEM_STRING_DECL(mqtt_color_mode_state_topic);
PROGMEM_STRING_DECL(mqtt_color_mode_value_template);
...
PROGMEM_STRING_DECL(mqtt_components);
...
PROGMEM_STRING_DECL(mqtt_color_mode);
PROGMEM_STRING_DECL(mqtt_content_type);
PROGMEM_STRING_DECL(mqtt_current_temperature_topic);
PROGMEM_STRING_DECL(mqtt_current_temperature_template);
PROGMEM_STRING_DECL(mqtt_default_entity_id);
PROGMEM_STRING_DECL(mqtt_device);
PROGMEM_STRING_DECL(mqtt_device_class);
PROGMEM_STRING_DECL(mqtt_direction_command_topic);
PROGMEM_STRING_DECL(mqtt_direction_command_template);
PROGMEM_STRING_DECL(mqtt_direction_state_topic);
PROGMEM_STRING_DECL(mqtt_direction_value_template);
PROGMEM_STRING_DECL(mqtt_display_precision);
PROGMEM_STRING_DECL(mqtt_encoding);
PROGMEM_STRING_DECL(mqtt_enabled_by_default);
PROGMEM_STRING_DECL(mqtt_entity_category);
PROGMEM_STRING_DECL(mqtt_entity_picture);
PROGMEM_STRING_DECL(mqtt_event_types);
...
PROGMEM_STRING_DECL(mqtt_flash);
...
PROGMEM_STRING_DECL(mqtt_effect_command_template);
...
PROGMEM_STRING_DECL(mqtt_group);
PROGMEM_STRING_DECL(mqtt_hs_command_topic);
PROGMEM_STRING_DECL(mqtt_hs_command_template);
...
PROGMEM_STRING_DECL(mqtt_image_encoding);
PROGMEM_STRING_DECL(mqtt_image_topic);
...
PROGMEM_STRING_DECL(mqtt_latest_version_topic);
PROGMEM_STRING_DECL(mqtt_latest_version_template);
PROGMEM_STRING_DECL(mqtt_last_reset_topic);
PROGMEM_STRING_DECL(mqtt_last_reset_value_template);
PROGMEM_STRING_DECL(mqtt_max);
PROGMEM_STRING_DECL(mqtt_max_humidity);
PROGMEM_STRING_DECL(mqtt_max_kelvin);
PROGMEM_STRING_DECL(mqtt_max_mireds);
PROGMEM_STRING_DECL(mqtt_max_temp);
PROGMEM_STRING_DECL(mqtt_migrate_discovery);
PROGMEM_STRING_DECL(mqtt_min);
PROGMEM_STRING_DECL(mqtt_min_humidity);
PROGMEM_STRING_DECL(mqtt_min_kelvin);
PROGMEM_STRING_DECL(mqtt_min_mireds);
PROGMEM_STRING_DECL(mqtt_min_temp);
PROGMEM_STRING_DECL(mqtt_mode);
...
PROGMEM_STRING_DECL(mqtt_platform);
...
PROGMEM_STRING_DECL(mqtt_payload_arm_vacation);
...
PROGMEM_STRING_DECL(mqtt_payload_direction_forward);
PROGMEM_STRING_DECL(mqtt_payload_direction_reverse);
PROGMEM_STRING_DECL(mqtt_payload_disarm);
PROGMEM_STRING_DECL(mqtt_payload_home);
PROGMEM_STRING_DECL(mqtt_payload_install);
...
PROGMEM_STRING_DECL(mqtt_payload_press);
PROGMEM_STRING_DECL(mqtt_payload_return_to_base);
PROGMEM_STRING_DECL(mqtt_payload_reset);
...
PROGMEM_STRING_DECL(mqtt_payload_stop_tilt);
...
PROGMEM_STRING_DECL(mqtt_reports_position);
...
PROGMEM_STRING_DECL(mqtt_pattern);
PROGMEM_STRING_DECL(mqtt_red_template);
PROGMEM_STRING_DECL(mqtt_release_summary);
PROGMEM_STRING_DECL(mqtt_release_url);
...
PROGMEM_STRING_DECL(mqtt_rgbw_command_topic);
PROGMEM_STRING_DECL(mqtt_rgbw_command_template);
PROGMEM_STRING_DECL(mqtt_rgbw_state_topic);
PROGMEM_STRING_DECL(mqtt_rgbw_value_template);
PROGMEM_STRING_DECL(mqtt_rgbww_command_topic);
PROGMEM_STRING_DECL(mqtt_rgbww_command_template);
PROGMEM_STRING_DECL(mqtt_rgbww_state_topic);
PROGMEM_STRING_DECL(mqtt_rgbww_value_template);
...
PROGMEM_STRING_DECL(mqtt_state_jammed);
PROGMEM_STRING_DECL(mqtt_state_locked);
PROGMEM_STRING_DECL(mqtt_state_locking);
...
PROGMEM_STRING_DECL(mqtt_state_unlocking);
PROGMEM_STRING_DECL(mqtt_state_value_template);
PROGMEM_STRING_DECL(mqtt_step);
PROGMEM_STRING_DECL(mqtt_subtype);
PROGMEM_STRING_DECL(mqtt_suggested_display_precision);
PROGMEM_STRING_DECL(mqtt_supported_color_modes);
PROGMEM_STRING_DECL(mqtt_support_duration);
PROGMEM_STRING_DECL(mqtt_supported_features);
PROGMEM_STRING_DECL(mqtt_support_volume_set);
...
PROGMEM_STRING_DECL(mqtt_title);
PROGMEM_STRING_DECL(mqtt_transition);
PROGMEM_STRING_DECL(mqtt_timezone);
PROGMEM_STRING_DECL(mqtt_unique_id);
PROGMEM_STRING_DECL(mqtt_unit_of_measurement);
PROGMEM_STRING_DECL(mqtt_url_topic);
PROGMEM_STRING_DECL(mqtt_url_template);
PROGMEM_STRING_DECL(mqtt_value_template);
PROGMEM_STRING_DECL(mqtt_visible_by_default);
PROGMEM_STRING_DECL(mqtt_white_command_topic);
PROGMEM_STRING_DECL(mqtt_white_scale);
PROGMEM_STRING_DECL(mqtt_xy_command_topic);
PROGMEM_STRING_DECL(mqtt_xy_command_template);
