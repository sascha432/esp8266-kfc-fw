...
PROGMEM_STRING_DEF(ping_monitor_end_response, "Total answer from %s sent %d recevied %d time %u ms");
...
PROGMEM_STRING_DEF(UTF8_micro, "\xC2\xB5");
PROGMEM_STRING_DEF(UTF8_microseconds, "\xC2\xB5" "s");
...
PROGMEM_STRING_DEF(week, "week");
PROGMEM_STRING_DEF(minute, "minute");
PROGMEM_STRING_DEF(second, "second");
PROGMEM_STRING_DEF(millisecond, "millisecond");
PROGMEM_STRING_DEF(microsecond, "microsecond");
PROGMEM_STRING_DEF(yr, "yr");
PROGMEM_STRING_DEF(mth, "mth");
PROGMEM_STRING_DEF(wk, "wk");
PROGMEM_STRING_DEF(hr, "hr");
